    ...
    return (
      <Column icon='asterisk' heading={intl.formatMessage(messages.heading)} hideHeadingOnMobile={true}>
        <div className='getting-started__wrapper'>
          ...
          <ColumnLink icon='nico' hideOnMobile={false} text='動画タイムライン' to='/timelines/tag/ニコニコ動画タイムライン' />
          <ColumnLink icon='nico' hideOnMobile={false} text='生放送タイムライン' to='/timelines/tag/ニコニコ生放送タイムライン' />
