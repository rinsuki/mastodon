  ...
  render () {
    ...
    return (
      <div className='detailed-status__action-bar'>
        ...
        <div style={{ flex: '1 1 auto', textAlign: 'center' }}><IconButton animate={true} active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='nicoru--status' onClick={this.handleFavouriteClick} activeStyle={{ color: '#ca8f04' }} /></div>
