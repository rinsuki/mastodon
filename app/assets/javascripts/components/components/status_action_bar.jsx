  ...
  render () {
    ...
    return (
      <div className='status__action-bar'>
        ...
        <div className='status__action-bar-button-wrapper'><IconButton animate={true} active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='nicoru--status' onClick={this.handleFavouriteClick} className='star-icon' /></div>
