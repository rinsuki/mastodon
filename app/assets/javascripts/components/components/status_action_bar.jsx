  ...
  render () {
    ...
    return (
      <div style={{ marginTop: '10px', overflow: 'hidden' }}>
        ...
        <div style={{ float: 'left', marginRight: '18px'}}><IconButton animate={true} active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='nicoru--status' onClick={this.handleFavouriteClick} activeStyle={{ color: '#ca8f04' }} /></div>
